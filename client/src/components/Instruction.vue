  ...
  <div class="instruction-area">
    ...
    <el-collapse v-model="activeNames" @change="onHandleChange">
      ...
      <el-collapse-item title="CLI 之上的图形化界面" name="3">
        ...
        <img class="image-desc" src="@assets/images/vue-cli-manage-cli-plugin.png" alt="Vue-Cli3 脚手架模版">
        <img class="image-desc" src="@assets/images/vue-cli-manage-project-dependencies.png" alt="Vue-Cli3 脚手架模版">
